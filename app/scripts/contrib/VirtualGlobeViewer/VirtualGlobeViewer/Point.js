 ...
 * Point object:
 *
 * Stores geo coordinates together with the corresponding 3D world coordinates.
 *
...
define(function() {
	...
	// 	// TODO: implement reasonabel constructor possibilities!
	// 	// Currently the point is constructed from a lat/lng pair.
	// 	if (latlng.length >= 2) {
	// 		_lat = latlng[0];
	// 		_lng = latlng[1];
	// 		_alt = latlng[2] || 0;

	// 		var pos3d = CoordinateSystem.fromGeoTo3D([_lat, _lng, _alt]);
	// 		_x = pos3d[0];
	// 		_y = pos3d[1];
	// 		_z = pos3d[2];
	// 	};
	...
	// 	return {
	// 		toArray: function() {
	// 			return [ _lat, _lng, _alt ];
	// 		},

	// 		set: function(lat, lng, alt) {
	// 			_lat = lat;
	// 			_lng = lng;
	// 			_alt = alt || 0;
	// 		},
	...
	// 		dump: function() {
	// 			console.log("Geo coordinates (lat/lng): (" + _lat + ", " + _lng + ", " + _alt + ")");
	// 			console.log("3D world coordinates:      (" + _x + ", " + _y + ", " + _z + ")");
	// 		}
	// 	}
	// }
