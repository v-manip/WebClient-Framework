...
define([
    ...
    function(
        Marionette, Communicator, App, MapModel, globals, Papa,
        tmplEvalModel, tmplEvalModelDiff, tmplGetFieldLines, tmplRetrieveSwarmFeatures) {
                            ...
                            if (band === 'Fieldlines' ){
                                ...
                                if(product.get('name')===layer){
                                    ...
                                    if(contours){
                                        ...
                                        esLayer.imageryProvider.updateProperties('dim_contours', 0);
                                    }
                                    if(style){
      ...
      checkFieldLines: function(){
        ...
        if(this.activeFL.length>0 && this.bboxsel){
                ...
                var url, model_id, color, band, style, range, logarithmic, parameters;
